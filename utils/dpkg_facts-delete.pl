...
my $delete = $dbh->prepare('DELETE FROM factoids WHERE key LIKE \'cmd:%\' or bar1 LIKE \'%$randnick%\' or key LIKE \'_default%\' or key LIKE \'#del# cmd:%\' or bar1=\'\' or bar1=\'%#del#%\' or key LIKE \'%#del#%\';');
$delete->execute();
